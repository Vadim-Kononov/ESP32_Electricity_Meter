...
/*Очевидно, что свои данные я скрыл*/
/*
...
month_before =  1,    //Номер месяца даты ежемесячного фиксирования показаний
minute,               //Минуты текущего времени
hour,                 //Часы текущего времени
day,                  //Номер дня текущей даты
month,                //Номер месяца текущей даты
saved_day =     31,   //Последний полученный номер дня
saved_minute =  0;    //Последние полученные минуты
